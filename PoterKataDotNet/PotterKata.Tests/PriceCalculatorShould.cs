...
public class PriceCalculatorShould
{
    ...
    {
        var priceWithDiscount = PriceCalculator.Calcule("first_book", "second_book", "third_book", "fourth_book");
    ...
    {
        var priceWithDiscount = PriceCalculator.Calcule("first_book", "second_book", "third_book", "fourth_book", "fith_book");
    ...
    {
        var priceWithDiscount = PriceCalculator.Calcule("first_book", "second_book", "third_book", "fourth_book", "fith_book", "first_book");
